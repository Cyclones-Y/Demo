...
if __name__ == "__main__":
    # model_name = "/root/.cache/huggingface/modules/transformers_modules/THUDM/chatglm2-6b/7fabe56db91e085c9c027f56f1c654d137bdba40"
    # # model_name =  "THUDM/chatglm2-6b"
    # print("本次加载的大语言模型为: {}".format(model_name))
    # tokenizer = AutoTokenizer.from_pretrained(model_name, trust_remote_code=True)
    # model = AutoModel.from_pretrained(model_name, trust_remote_code=True).cuda()
    embeddings_model = SentenceTransformer('/mnt/e/model/bce-embedding-base_v1', device='cuda')
    print("本次加载的向量模型为：m3e-large")
    uvicorn.run(app,  port=6006, workers=1)
